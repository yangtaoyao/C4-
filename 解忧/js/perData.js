		...
		function(t, status) {
			...
			if(status == 200) {
				...
				if(res.suc < 0) {
					...
					setting.imgUrl = common.imgUrl + "user/" + setting.uid + "/" + res.msg;
					setting.imgUrl = setting.imgUrl.replace(';', '');
...
function changeInfo() {
	console.log("保存信息");
	console.log("nickname:" + setting.sex == "" ? " 空格" : setting.sex);
	var wt = plus.nativeUI.showWaiting();
	req = {
		//action: 'changeInfo',
...
function initData() {
	...
	console.log("initData:" + str);
	setting.uid = userInfo.uid;
...
function getImage() {
	...
	c.captureImage(function(e) {
		plus.io.resolveLocalFileSystemURL(e, function(entry) {
			...
			console.log('head-img createUpload path:' + s);
			createUpload(s, "head_img");
		}, function(e) {
			...
			plus.io.resolveLocalFileSystemURL("_doc/", function(root) {
				...
				root.getFile("head.jpg", {}, function(file) {
					...
					file.remove(function() {
						...
						entry.copyTo(root, 'head'+new Date().getTime()+'.jpg', function(e) {
								...
								console.log('head-img createUpload path e:' + e);
								createUpload(e, "head_img");
							},
							function(e) {
					...
					entry.copyTo(root, 'head'+new Date().getTime()+'.jpg', function(e) {
							...
							console.log('head-img createUpload path:' + path);
							createUpload(path, "head_img");
					},
						function(e) {
							console.log('copy image fail:' + e.message);
						});
